...
export class AnalyticsLogger {
  public trackEvent(category: string, value: string): void {
    // Send the event through the project's analytics provider.
  }
}
```
...
export class Navbar {
  ...
  public navigateToDetail(event: Event): void {
...
export class Example {
  private readonly service1 = inject(MyService); // ✅ Field initializer

  private readonly service2: MyService;
  public constructor() {
...
export class MyDirective {
  private readonly element = inject(ElementRef); // ✅ Field initializer
}
