...
export class User {
  ...
  public readonly name = input('Guest');

  // Required input
  public readonly age = input.required<number>();
...
export class CustomButton {
  // Alias example
  public readonly label = input('', { alias: 'btnLabel' });
...
export class Legacy {
  ...
  @Input({ transform: trimString }) public label = '';
}
```
