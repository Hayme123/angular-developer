...
- **TypeScript**: Types, naming, control flow, class organization, and logging. Read [typescript.md](references/typescript.md)
...
- **Component Pantry**: Search the company component index before creating visual UI or adding a UI dependency. Read [Component Pantry](references/component-pantry/index.md), then open only the selected component reference.
- **Fundamentals**: Company component structure, core concepts, and template control flow (`@if`, `@for`, `@switch`). Read [components.md](references/components.md)
...
- **Styling components**: SCSS, BEM, encapsulation, semantic tokens, and Pantry override rules. Read [component-styling.md](references/component-styling.md)
- **Using Tailwind CSS with Angular**: Project-version-aware integration. Read [tailwind-css.md](references/tailwind-css.md)
...
- **Fundamentals**: JSDoc, `data-testid`, completion checks, async patterns, and `TestBed`. Read [testing-fundamentals.md](references/testing-fundamentals.md)
